...
TRANSLATIONS = {
    ...
    "hero_text": {
        ...
        "hi": "लाइव पोज़्चर फीडबैक, निर्देशित एक्सरसाइज संदर्भ और अपलोड-आधारित समीक्षा के साथ बेहतर फॉर्म बनाएं।",
    },
    "selected_exercise": {"en": "Selected Exercise", "hi": "चयनित एक्सरसाइज"},
    "training_library": {"en": "Training Library", "hi": "प्रशिक्षण लाइब्ररी"},
    ...
    "exercise_reference_title": {"en": "Exercise reference and setup guide", "hi": "एक्सरसाइज संदर्भ और सेटअप गाइड"},
    "exercise_reference_copy": {
        ...
        "hi": "प्रशिक्षण से पहले चयनित मूवमेंट की समीक्षा करें ताकि कैमरा एंगल, सेटअप और मुख्य तकनीकी संकेत स्पष्ट हों।",
    },
    "live_coach": {"en": "Live Coach", "hi": "लाइव कोच"},
    "webcam_posture": {"en": "Webcam posture stream", "hi": "वेबकैम पोज़्चर स्ट्रीम"},
    "webcam_posture_copy": {
        "en": "Use the live camera feed for real-time pose feedback, then switch to uploaded media for slower review if needed.",
        "hi": "रीयल-टाइम पोज़ फीडबैक के लिए लाइव कैमरा फ़ीड का उपयोग करें, और ज़रूरत पर अपलोड की गई मीडिया से धीमी समीक्षा करें।",
    },
    "upload_analysis": {"en": "Upload Analysis", "hi": "अपलोड विश्लेषण"},
    "photo_video_review": {"en": "Photo or video review", "hi": "फोटो या वीडियो समीक्षा"},
    "photo_video_review_copy": {
        ...
        "hi": "त्वरित स्नैपशॉट के लिए वर्कआउट फोटो अपलोड करें या फ़्रेम-बाय-फ़्रेम पोज़ समीक्षा के लिए वीडियो अपलोड करें, डाउनलोडयोग्य आउटपुट के साथ।",
    },
    ...
    "session_insights": {"en": "Session Insights", "hi": "सत्र अंतर्दृष्टि"},
    "live_metrics_title": {"en": "Live metrics and coaching", "hi": "लाइव मीट्रिक्स और कोचिंग"},
    "live_metrics_copy": {
        "en": "Monitor your current form quality, hold time, and coaching prompts while you train.",
        "hi": "प्रशिक्षण के दौरान अपनी वर्तमान फॉर्म गुणवत्ता, होल्ड समय और कोचिंग संकेत देखें।",
    },
    "session_state": {"en": "Session State", "hi": "सत्र स्थिति"},
    "exercise": {"en": "Exercise", "hi": "एक्सरसाइज"},
    "reps": {"en": "Reps", "hi": "रेप्स"},
    "form_score": {"en": "Form Score", "hi": "फॉर्म स्कोर"},
    "hold_time": {"en": "Hold Time", "hi": "होल्ड समय"},
    "feedback": {"en": "Feedback", "hi": "फीडबैक"},
    "exercise_guide": {"en": "Exercise Guide", "hi": "व्यायाम मार्गदर्शिका"},
    "how_to_perform": {"en": "How To Perform", "hi": "कैसे करें"},
    "step_by_step": {"en": "Step by step", "hi": "कदम दर कदम"},
    "why_it_helps": {"en": "Why It Helps", "hi": "यह कैसे मदद करता है"},
    "benefits": {"en": "Benefits", "hi": "लाभ"},
    "trainer_care": {"en": "Trainer Care", "hi": "ट्रेनर देखभाल"},
    "trainer_care_title": {"en": "Train safely and consistently", "hi": "सुरक्षित और निरंतर ट्रेनिंग करें"},
    "trainer_care_copy": {
        ...
        "hi": "कोच का उपयोग एक सहायक उपकरण के रूप में करें, लेकिन अपने वर्कआउट को असली ट्रेनिंग सत्र की तरह रखें: पहले तैयार हों, नियंत्रण के साथ चलें, और प्रयासों के बीच रिकवर करें।",
    },
    "coach_settings": {"en": "Coach Settings", "hi": "कोच सेटिंग्स"},
    "language": {"en": "Language", "hi": "भाषा"},
    "category": {"en": "Category", "hi": "श्रेणी"},
    "setup_tips": {"en": "Setup Tips", "hi": "सेटअप सुझाव"},
    "notes": {"en": "Notes", "hi": "नोट्स"},
    "gym exercises": {"en": "Gym Exercises", "hi": "जिम एक्सरसाइज"},
    "asana exercises": {"en": "Asana Exercises", "hi": "आसन अभ्यास"},
}
    ...
    with st.sidebar:
        ...
        selected_language = st.selectbox(
            ...
            index=(list(LANGUAGE_OPTIONS.keys()).index(st.session_state.get("language", "en"))
                   if st.session_state.get("language", "en") in list(LANGUAGE_OPTIONS.keys())
                   else 0),
        )
